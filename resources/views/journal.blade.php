  ...
  <div class="content">
    <div class="container">
      ...
      {{-- 平板版顯示 --}}
        ...
        {{-- 手機版顯示 --}}
        <nav class="searchSide showForPhone hideForPhablet hideForTablet hideForDesktop hidden margin-top-phablet-7 fix-12-12" style="float:left;position:absolute;">
          <div class="sections">
              <div class="left">
